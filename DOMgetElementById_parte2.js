...
titulo.style.backgroundColor = '#E6E6FA';
...
items[1].style.backgroundColor = '#6A5ACD';

for (let i = 0; i < items.length; i++) {
    items[i].style.backgroundColor = '##20B2AA';
    }
...
else li[i].style.backgroundColor = '#6A5ACD';
}
...
nome[0].style.backgroundColor = '#9370DB';
